...
** Bug in RBTools when posting binary files, such as jar files
   
   With 0.6.3, binary files don't get listed in the review.  They do with
   0.5.2.  Test it with 0.7.x and report bug if needed.
...
* Done
** DONE BUG: .rbtools-cookie file not being properly saved
...
** DONE BZ 475344
   ...
   Test that we now properly handle 'p4 move' files

** DONE Write announcement
