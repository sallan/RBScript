...
*** Whiteboard:
   ...
   - [ ] Create new linux user mergeit with no RB account
   - [ ] Try posting from there as sallan with the --submit-as option
   - [ ] Create new user buffy with an RB account
   - [ ] Have buffy try posting as uid mergeit WITHOUT the --submit-as option.
   - [ ] Have buffy try posting as uid mergeit with the --submit-as option.
