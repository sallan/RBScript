...
** TODO Dev should be able to post a review from the mergeit account
...
*** TODO Create new linux user mergeit with no RB account

*** TODO Try posting from there as sallan with the --submit-as option

*** TODO Create new user buffy with an RB account

*** TODO Have buffy try posting as uid mergeit WITHOUT the --submit-as option.

*** TODO Have buffy try posting as uid mergeit with the --submit-as option.
    ...
    - Write a wrapper script for post merges as mergeit that handles
      the authentication. Maybe review the old post-merge-review script.


** TODO Working via the rid
*** TODO Dev submits a review with a different CL using rid and we update the CL in RB
...
**** TODO This may be fixed by the upstream rbtools project. Need to file a bug
     But you don't know how long it will take them to fix it, so you
     may still want to see if you can update the CL yourself.

* Product Backlog
** Dev should be able to create new review from submitted CL or range of CLs
